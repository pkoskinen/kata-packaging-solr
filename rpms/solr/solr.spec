...
%description
SOLR binary package, for version 4.7.2. Installs to a tomcat6 installation as war file and example data files.
...
mv $RPM_BUILD_DIR/solr-4.7.2/example/solr $RPM_BUILD_ROOT/opt/data
mv $RPM_BUILD_DIR/solr-4.7.2/dist/solr-4.7.2.war $RPM_BUILD_ROOT/opt/data/solr/solr.war
mv $RPM_BUILD_DIR/solr-4.7.2/example/lib/ext/* $RPM_BUILD_ROOT/usr/share/tomcat6/lib/
mv $RPM_BUILD_DIR/solr-4.7.2/example/resources/log4j.properties $RPM_BUILD_ROOT/opt/data/solr/
install -d $RPM_BUILD_ROOT/opt/data/solr/lib
mv $RPM_BUILD_DIR/solr-4.7.2/dist/solr-clustering-4.7.2.jar $RPM_BUILD_ROOT/opt/data/solr/lib/
mv $RPM_BUILD_DIR/solr-4.7.2/contrib/clustering/lib/* $RPM_BUILD_ROOT/opt/data/solr/lib/
